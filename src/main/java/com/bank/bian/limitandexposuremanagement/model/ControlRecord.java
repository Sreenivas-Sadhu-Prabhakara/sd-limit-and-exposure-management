package com.bank.bian.limitandexposuremanagement.model;
...
/**
 * The BIAN control record for this service domain: "Exposure Limit Management Plan".
 *
 ...
 * to its asset type (Exposure Limit). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Exposure Limit Management Plan";
